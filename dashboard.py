...
with row1col2:
    ...
    st.write("[KVH hranoly NSi Smrk, délka 5000 - 40x100x5000](https://www.artisan.cz/kvh-hranoly-delka-5000-40x100x5000-m)")
    st.write("[KVH hranoly NSi Smrk, délka 5000 - 40x120x5000](https://www.artisan.cz/kvh-hranoly-delka-5000-40x120x5000-u)")
...
with c1:
    ...
    with h1:
        st.subheader("KVH hranoly 40x100x5000")
    ...
    with row2col2:
        ...
        st.metric("Nejnižší cena", round(max_price,1))

    with row2col3:
        mean_price = data["kvh40x100x500"].mean()
        st.metric("Nejnižší cena", round(mean_price,1))


with c2:
    h1, h2, h3 = st.columns(3)
    with h1:
        st.subheader("KVH hranoly 40x120x5000")
    row2col1, row2col2, row2col3, = st.columns(3)
